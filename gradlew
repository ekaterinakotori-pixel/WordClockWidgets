...
if [ "$cygwin" = "true" -o "$msys" = "true" ] ; then
    ...
    for arg in "$@" ; do
        ...
        if [ $CHECK -ne 0 ] && [ "$FOUND_NON_OPT" = "true" ] ; then                    ### Added a condition
...
#   * gradle property args for this script
#   * default jvm options
#   * jvm options from java.properties file
#   * jvm options from GRADLE_OPTS and JAVA_OPTS environment variables.
